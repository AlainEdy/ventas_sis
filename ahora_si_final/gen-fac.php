...
try {
    // Consulta para obtener los productos con id, nombre, descripción y precio
    ...
    foreach ($productos as $producto) {
        // Usamos el id como valor para que sea fácil obtener los detalles más tarde
        // También añadimos los datos de descripción y precio como atributos data- en el option
...
<?php
// Inicializar variables de sesión o procesamiento del formulario si es necesario
session_start();

// Si el formulario fue enviado
if ($_SERVER['REQUEST_METHOD'] === 'POST') {

    // Datos del emisor (estos pueden venir de una configuración o base de datos)


    // Procesar datos del cliente
    $cliente = $_POST['cliente'];

    // Procesar datos del comprobante
...
<body class="bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h2 class="text-3xl font-bold text-gray-900 mb-8">Generar Factura Electrónica</h2>

        <!-- Datos del Emisor -->
        <div class="bg-white shadow-lg bg-blue-500 rounded-lg mb-6">
            <div class="bg-gray-800  px-6 py-4 border-b border-gray-200 rounded-t-lg">
        ...
        <form id="facturaForm" method="POST" action="" class="space-y-6">
            ...
            <div class="bg-white shadow-lg rounded-lg">
                <div class="bg-gray-800 px-6 pt-4 mt-4 rounded-t-lg overflow-x-scroll md:overflow-hidden">
                        ...
                        <table class="min-w-full table-auto border-collapse table-fixed">
                            <thead>
                                <tr class="bg-gray-800 text-white">
                                    <th class="py-2 border-b text-center" style="width: 12%;">Código</th>
                                    <th class="py-2 border-b text-center" style="width: 12%;">Nombre Prod.</th>
                                    <th class="py-2 border-b text-center" style="width: 12%;">Descripción del Prod.</th>
                                    <th class="py-2 border-b text-center" style="width: 12%;">Precio</th>
                                    <th class="py-2 border-b text-center" style="width: 12%;">Cant.</th>
                                    <th class="py-2 border-b text-center" style="width: 12%;">Tipo de Afectación</th>
                                    <th class="py-2 border-b text-center" style="width: 12%;">Subtotal</th>
                                    <th class="py-2 border-b text-center" style="width: 12%;">Acción</th>
                                </tr>
                            </thead>
                        ...
                        <div class="w-full  mr-auto">
                            <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600">Op. Gravadas:</span>
                                    <span id="totalOpGravadas" class="text-sm font-medium">0.00</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600">Op. Exoneradas:</span>
                                    <span id="totalOpExoneradas" class="text-sm font-medium">0.00</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600">Op. Inafectas:</span>
                                    <span id="totalOpInafectas" class="text-sm font-medium">0.00</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600">IGV:</span>
...
<div class="md:col-span-1">
    <textarea name="detalle[${productoCount}][descripcion]" 
              ...
              oninput="this.style.height = ''; this.style.height = this.scrollHeight + 'px';"></textarea>
                ...
                <div>
    <input type="number" 
           name="detalle[${productoCount}][cantidad]" 
           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 cantidad" 
           placeholder="Cant." 
           required 
           min="0" 
           step="any"> <!-- 'step="any"' permite decimales si se necesitan -->
</div>
        ...
        `;
                ...
                function rellenarDatosProducto(id) {
                    ...
                    if (productoSeleccionado.value) {
                        ...
                        codigo.value = productoSeleccionado.getAttribute('value'); // El ID del producto se guarda en el código
                    } else {
...
<body>
    <div class="header">
        ...
        <div>' . $comprobante['serie'] . '-' . str_pad($comprobante['correlativo'], 8, "0", STR_PAD_LEFT) . '</div>
    </div>
    ...
    <div class="info-section">
        ...
        <p><strong>RUC:</strong> ' . $cliente['nrodoc'] . '</p>
...
$html .= '
    ...
    <div class="footer">
        <strong>Son:</strong> ' . $comprobante['total_texto'] . '
    </div>';
...
if ($comprobante['forma_pago'] == 'Credito') {
    ...
    foreach ($cuotas as $cuota) {
        $html .= '
        <p>' . $cuota['cuota'] . ' - <strong>Monto:</strong> S/ ' . number_format($cuota['monto'], 2) .
            ' - <strong>Fecha:</strong> ' . $cuota['fecha'] . '</p>';
    }
...
// Botón en verde
echo '<a href="http://localhost/ahora_si_final/' . $nombreArchivo . '" 
